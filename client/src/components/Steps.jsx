      ...
      <div className="flex items-start flex-wrap gap-4 mt-16 xl:mt-24 justify-center">
        <div className="flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500">
          ...
          <div>
            ...
            <p className="text-sm text-neutral-500">
              Upload your image to instantly remove the background and <br />{" "}
        ...
        <div className="flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500">
          ...
          <div>
            ...
            <p className="text-sm text-neutral-500">
              Remove the background from your image instantly with just <br />
              one click for a clean, professional look.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500">
          ...
          <div>
            ...
            <p className="text-sm text-neutral-500">
              Download your image with a transparent background in high <br />
              quality, ready for use anywhere.
            </p>
          </div>
        </div>
      </div>
